...
**7. TEHTY: /tread-monitor hakee code review -statuksen ja tarkistaa deployn luvallisuuden**
...
## Suositus: anonymisoi ennen lähettämistä

Tämä tietoturvamalli valvoo että Leiman koodi ei muutu luvatta — mutta se ei estä palveluntarjoajia (Anthropic, Vercel, jne.) näkemästä lähettämääsi sisältöä. Suosittelemme anonymisoimaan arkaluonteiset tiedot ennen kuin lähetät ne LLM:lle.

Suunnitteilla: [Proteus](PROTEUS.md) — semanttinen chaff-kerros joka generoi uskottavia mutta keinotekoisia variantteja jokaisesta dokumentistasi, jolloin ulkopuolinen tarkkailija ei voi tietää mikä on aito.
