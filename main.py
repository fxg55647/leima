...
_KV_DEPLOY_INCOMING_TTL = 900  # 15 minutes — covers code review + deploy cycle
...
async def api_deploy_incoming(request: Request):
    ...
    return {"ok": True, "sha": sha, "kv_configured": kv_configured, "kv_stored": readback is not None, "kv_sha": (readback or {}).get("sha")}
